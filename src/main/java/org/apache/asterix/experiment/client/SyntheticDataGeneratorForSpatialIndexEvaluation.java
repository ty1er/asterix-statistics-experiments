...
import org.apache.asterix.experiment.datagen.DataGeneratorForSpatialIndexEvaluation;
...
public class SyntheticDataGeneratorForSpatialIndexEvaluation {
    public static void main(String[] args) throws Exception {
        ...
        DataGeneratorForSpatialIndexEvaluation dataGenerator = new DataGeneratorForSpatialIndexEvaluation(
                new InitializationInfo(), pointSourceFilePath, pointSampleInterval);
        ...
        TweetMessageIterator tweetIterator = dataGenerator.new TweetMessageIterator(0, config.getPartitionId(), 4);
