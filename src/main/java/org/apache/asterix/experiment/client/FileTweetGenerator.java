...
import org.apache.asterix.experiment.datagen.DataGeneratorStatistics.InitializationInfo;
import org.apache.asterix.experiment.datagen.DataGeneratorStatistics.TweetMessageIterator;
import org.apache.asterix.experiment.datagen.DataGeneratorStatistics;
import org.apache.asterix.experiment.datagen.SpreadDistributionType;
...
public class FileTweetGenerator {
    public static void main(String[] args) throws Exception {
        ...
        DataGeneratorStatistics dataGenerator = new DataGeneratorStatistics(new InitializationInfo(
                SpreadDistributionType.Uniform));
        ...
        TweetMessageIterator tweetIterator = dataGenerator.new TweetMessageIterator(0, config.getPartitionId(),
