...
public class TweetGeneratorStatistics {

    private static Logger LOGGER = Logger.getLogger(TweetGeneratorStatistics.class.getName());
    ...
    public TweetGeneratorStatistics(Map<String, String> configuration, int partition, String format, OutputStream os)
            throws Exception {
