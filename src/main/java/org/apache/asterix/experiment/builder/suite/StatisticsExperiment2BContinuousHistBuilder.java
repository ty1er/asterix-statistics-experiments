...
public class StatisticsExperiment2BContinuousHistBuilder extends AbstractLSMBaseExperimentBuilder
        ...
        public StatisticsExperiment2BContinuousHistBuilder(LSMExperimentSetRunnerConfig config) {
                super(config);
        }
}
