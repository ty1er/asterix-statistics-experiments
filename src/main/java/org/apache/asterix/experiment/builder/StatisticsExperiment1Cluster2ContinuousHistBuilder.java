...
public class StatisticsExperiment1Cluster2ContinuousHistBuilder extends AbstractLSMBaseExperimentBuilder implements
        IExperiment1Builder, IDgen2Builder, ICluster2Builder, IIngest2Builder, IContinuousHistConfigBuilder {

    public StatisticsExperiment1Cluster2ContinuousHistBuilder(LSMExperimentSetRunnerConfig config) {
        super(config);
    }

    @Override
    public String getName() {
        return "StatisticsExperiment1Cluster2ContinuousHist";
    }
}
